# Registro de alteracoes - `strings.xml`

Arquivo base: `android-app/app/src/main/res/values/strings.xml`
Arquivo de registro: `android-app/docs/alteracoes/res/values/strings.xml.md`
...
Tamanho atual: 79 bytes; 3 linhas; sha256 curto: `90d02c595eec081a`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `android-app/app/src/main/res/values/strings.xml` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
