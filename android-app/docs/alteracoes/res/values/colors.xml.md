# Registro de alteracoes - `colors.xml`

Arquivo base: `android-app/app/src/main/res/values/colors.xml`
Arquivo de registro: `android-app/docs/alteracoes/res/values/colors.xml.md`
...
Tamanho atual: 77 bytes; 3 linhas; sha256 curto: `884cfb71b60f8dee`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `android-app/app/src/main/res/values/colors.xml` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
