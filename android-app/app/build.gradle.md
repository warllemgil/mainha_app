# Registro de alteracoes - `build.gradle`

Arquivo base: `android-app/app/build.gradle`
Arquivo de registro: `android-app/app/build.gradle.md`
...
Tamanho atual: 1016 bytes; 32 linhas; sha256 curto: `d040b980f71582b3`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `android-app/app/build.gradle` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
