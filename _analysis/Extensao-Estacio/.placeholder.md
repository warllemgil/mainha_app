...
Arquivo base: `_analysis/Extensao-Estacio/.placeholder`
Arquivo de registro: `_analysis/Extensao-Estacio/.placeholder.md`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `_analysis/Extensao-Estacio/.placeholder` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
