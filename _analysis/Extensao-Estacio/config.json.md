# Registro de alteracoes - `config.json`

Arquivo base: `_analysis/Extensao-Estacio/config.json`
Arquivo de registro: `_analysis/Extensao-Estacio/config.json.md`
...
Tamanho atual: 539 bytes; 19 linhas; sha256 curto: `0c463b12aa7e94d7`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `_analysis/Extensao-Estacio/config.json` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
