# Registro de alteracoes - `requirements.txt`

Arquivo base: `backend/requirements.txt`
Arquivo de registro: `backend/requirements.txt.md`
...
Tamanho atual: 118 bytes; 6 linhas; sha256 curto: `fad2882ac6735548`
...
Este arquivo `.md` deve ser atualizado sempre que o arquivo base `backend/requirements.txt` receber qualquer alteracao antes de commit/push. Registre aqui o que mudou, por que mudou e qualquer impacto esperado em build, execucao, deploy, testes ou artefatos gerados.
